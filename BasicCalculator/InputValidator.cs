...
namespace BasicCalculator
{
    class InputValidator
    {
        ...
        /**
         * Reads a float from user input. Throws a Data.ConstraintException if
         * the input cannot be parsed.
         **/
        public float ReadFloat()
        {
            float input;
            bool isNumeric = float.TryParse(Console.ReadLine(), out input);
        ...
        public string ReadBinaryMathOperator()
        {
            ...
            if (input.Equals("+") || input.ToLower().Equals("plus")) return "+";
